...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "delta-dark-fhd/skin.xml" or "delta-purple-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
